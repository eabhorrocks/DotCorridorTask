...
for ispeed = 1:numel(meanSpeeds)
    ...
    [speed(ispeed).t50, speed(ispeed).t50CI] = getThreshold(speed(ispeed).psigResult, 0.5, true);
    [speed(ispeed).t70, speed(ispeed).t70CI] = getThreshold(speed(ispeed).abspsigResult, 0.7, true);
